...
// Dummy medicines database - Site B (Budget, Lower Prices)
const medicines = [
  {
    id: 1,
    name: 'BudgetVit D',
    ...
    image: '/images/vitd.jpg'
  },
  {
    id: 2,
    name: 'QuickRelief Tablets',
    price: 150,
    delivery: '3-4 days',
    rating: 4.1,
    description: 'Budget pain relief tablets',
  ...
  },
  {
    ...
    delivery: '3-4 days',
    rating: 4.0,
    description: 'Generic antibiotic medicine',
    image: '/images/antibio.jpg'
  },
  {
    id: 4,
    name: 'BasicCalcium',
    ...
    delivery: '4-5 days',
    rating: 4.1,
    description: 'Basic calcium supplement',
  ...
  },
  {
    ...
    delivery: '3-4 days',
    rating: 4.0,
    description: 'Value multivitamin pack',
    image: '/images/vitamins.jpg'
  },
  {
    id: 6,
    name: 'EconomyDigestive',
    price: 120,
    delivery: '4-5 days',
    rating: 3.9,
    description: 'Economy digestive aid',
...
app.get('/api/medicines', (req, res) => {
  res.json({
    success: true,
    site: 'Site B - Budget Medicine Store',
    medicines
  });
});
...
app.listen(PORT, () => {
  console.log(`\n💰 Site B Backend (Budget) running on http://localhost:${PORT}\n`);
});
